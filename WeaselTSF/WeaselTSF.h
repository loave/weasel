...
class WeaselTSF : public ITfTextInputProcessorEx,
 ...
 private:
  ...
  BOOL _SkipAutoPairSynthKey(WPARAM wParam, BOOL* pfEaten);
  ...
  /* [auto_pair] whether the keydown being handled is one Windows generated by
   * holding the key down (lParam bit 30) */
  BOOL _apKeyIsAutoRepeat = FALSE;
